...
export const chickenIcon = icon({
  ...
  iconAnchor: [-ICON_SIZE_DEFAULT/2, 0], // point of the icon which will correspond to marker's location
...
export const cowIcon = icon({
  ...
  iconSize: [ICON_SIZE_DEFAULT, ICON_SIZE_DEFAULT], // size of the icon
  iconAnchor: [0, ICON_SIZE_DEFAULT * 0.7], // point of the icon which will correspond to marker's location
});
